...
@section('content')
    <div class="row">
        <div class="col-lg-2">
            <a href="{{ URL::action('RepresentativesController@index')}}/{{$representative->id}}/edit">
                <h2 class="link">
                    @lang('variables.edit')
            ...
            @if(Auth::user()->type=='admin')
                <a href="{{ URL::action('RepresentativesController@index')}}/{{$representative->id}}/delete">
                    <h2 class="link">
        ...
        <div class="col-lg-8">
            <div class="panel panel-default">
                <div class="color title2 panel_title">
                    ...
                    <a href="{{ URL::action('RepresentativesController@index')}}/{{$representative->id}}">
                        {{$representative->name}}
                    </a>
